...
import com.exparo.wallet.ui.theme.ExparoLight
import com.exparo.wallet.ui.theme.Orange
import com.exparo.wallet.ui.theme.Red
import com.exparo.wallet.ui.theme.RedLight
import com.exparo.wallet.ui.theme.White
import com.exparo.wallet.ui.theme.components.BalanceRow
import com.exparo.wallet.ui.theme.components.BalanceRowMini
import com.exparo.wallet.ui.theme.components.CircleButtonFilledGradient
import com.exparo.wallet.ui.theme.components.CloseButton
import com.exparo.wallet.ui.theme.components.ItemIconM
...
import com.exparo.wallet.ui.theme.gradientExpenses
...
private fun BoxWithConstraintsScope.UI(
    ...
    val percentExpanded by animateFloatAsState(
        ...
        animationSpec = com.exparo.legacy.utils.springBounce(),
...
private fun Header(
    ...
    period: com.exparo.legacy.data.model.TimePeriod,
            ...
            if (percentExpanded > 0f) {
                ...
                CircleButtonFilledGradient(
                    modifier = Modifier
                        ...
                        .alpha(percentExpanded)
                        .size(com.exparo.legacy.utils.lerp(1, 40, percentExpanded).dp),
                    iconPadding = 4.dp,
...
private fun Preview_Expense() {
    com.exparo.legacy.ExparoWalletPreview {
        val state = PieChartStatisticState(
            ...
            period = com.exparo.legacy.data.model.TimePeriod.currentMonth(
                startDayOfMonth = 1
            ), // preview
            baseCurrency = "BGN",
            totalAmount = 1828.0,
            categoryAmounts = persistentListOf(
                ...
                CategoryAmount(
                    category = Category(
                        ...
                        color = ColorInt(ExparoLight.toArgb()),
