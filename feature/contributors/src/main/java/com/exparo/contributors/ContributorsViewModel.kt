...
class ContributorsViewModel @Inject constructor(
    private val exparoWalletRepositoryDataSource: ExparoWalletRepositoryDataSource,
    ...
    private suspend fun fetchContributors() {
        val contributorsResult = exparoWalletRepositoryDataSource.fetchContributors()
    ...
    private suspend fun fetchProjectInfo() {
        val responseInfo = exparoWalletRepositoryDataSource.fetchRepositoryInfo()
