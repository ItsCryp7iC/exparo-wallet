...
import com.exparo.frp.forward
import com.exparo.frp.then2
import com.exparo.home.Constants.SWIPE_HORIZONTAL_THRESHOLD
import com.exparo.home.customerjourney.CustomerJourney
...
import com.exparo.legacy.ui.component.transaction.TransactionsDividerLine
import com.exparo.legacy.ui.component.transaction.transactions
import com.exparo.legacy.utils.horizontalSwipeListener
import com.exparo.legacy.utils.rememberSwipeListenerState
import com.exparo.legacy.utils.verticalSwipeListener
...
import com.exparo.wallet.ui.theme.modal.BufferModal
import com.exparo.wallet.ui.theme.modal.BufferModalData
import com.exparo.wallet.ui.theme.modal.ChoosePeriodModal
import com.exparo.wallet.ui.theme.modal.ChoosePeriodModalData
import com.exparo.wallet.ui.theme.modal.CurrencyModal
...
fun BoxWithConstraintsScope.HomeUi(
    ...
    var moreMenuExpanded by remember { mutableStateOf(exparoContext.moreMenuExpanded) }
    ...
    val setMoreMenuExpanded = { expanded: Boolean ->
        ...
        exparoContext.setMoreMenuExpanded(expanded)
    }
    ...
    Column(
        ...
        val listState = rememberScrollPositionListState(
            ...
            initialFirstVisibleItemIndex = exparoContext.transactionsListState
                ?.firstVisibleItemIndex ?: 0,
            initialFirstVisibleItemScrollOffset = exparoContext.transactionsListState
    ...
    CurrencyModal(
        ...
        initialCurrency = ExparoCurrency.fromCode(baseCurrency),
