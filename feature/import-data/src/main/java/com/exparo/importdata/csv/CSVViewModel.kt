package com.exparo.importdata.csv
...
import com.exparo.importdata.csv.domain.CSVImporterV2
import com.exparo.importdata.csv.domain.SAMPLE_SIZE
import com.exparo.importdata.csv.domain.parseAccount
import com.exparo.importdata.csv.domain.parseAccountCurrency
import com.exparo.importdata.csv.domain.parseAmount
import com.exparo.importdata.csv.domain.parseCategory
import com.exparo.importdata.csv.domain.parseDate
import com.exparo.importdata.csv.domain.parseDescription
import com.exparo.importdata.csv.domain.parseStatus
import com.exparo.importdata.csv.domain.parseTitle
import com.exparo.importdata.csv.domain.parseToAccount
import com.exparo.importdata.csv.domain.parseToAccountCurrency
import com.exparo.importdata.csv.domain.parseTransactionType
...
class CSVViewModel @Inject constructor(
    ...
    private var accountCurrency by mutableStateOf(
        ColumnMapping(
            exparoColumn = "Account Currency",
            helpInfo = """
                The currency of the account that made the transaction.
                In Exparo Wallet, transactions don't have a currency but inherit
    ...
    private var toAccountCurrency by mutableStateOf(
        ColumnMapping(
            exparoColumn = "To Account Currency",
            helpInfo = """
        ...
        withContext(Dispatchers.IO) {
            val result = csvImporter.import(
                ...
                onProgress = { progressPercent ->
                    com.exparo.legacy.utils.uiThread {
