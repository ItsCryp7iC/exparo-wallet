...
data class ReportScreenState(
    ...
    val upcomingTransactions: ImmutableList<com.exparo.base.legacy.Transaction> = persistentListOf(),
    val overdueTransactions: ImmutableList<com.exparo.base.legacy.Transaction> = persistentListOf(),
    ...
    val transactions: ImmutableList<com.exparo.base.legacy.Transaction> = persistentListOf(),
