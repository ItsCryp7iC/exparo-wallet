...
import com.exparo.legacy.utils.springBounceFast
...
fun BoxWithConstraintsScope.BottomBar(
    ...
    val screenHeightDp = densityScope { exparoContext.screenHeight.toDp() }
...
// swipe up right
        ...
        backgroundGradient = when (tab) {
            ...
            MainTab.HOME -> {
                ...
                if (!expanded) GradientExparo else Gradient.solid(UI.colors.gray)
...
private fun TransactionButtons(
    ...
    if (buttonsShownPercent > 0.01f) {
        ...
        val buttonRightX = exparoContext.screenWidth - bH.toDensityPx() - FAB_BUTTON_SIZE.toDensityPx()
        ...
        val clickAreaWidth = exparoContext.screenWidth / 3
                ...
                .layout { measurable, constraints ->
                    ...
                    layout(placealbe.width, placealbe.height) {
                        ...
                        placealbe.place(
                            ...
                            x = exparoContext.screenWidth / 2 - placealbe.width / 2,
