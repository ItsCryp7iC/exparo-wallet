package com.exparo.poll.impl.ui
...
import com.exparo.poll.data.model.Poll
import com.exparo.poll.data.model.PollId
import com.exparo.poll.data.model.PollOption
import com.exparo.poll.data.model.PollOptionId
import com.exparo.poll.impl.domain.VoteUseCase
...
class PollViewModel @Inject constructor(
  ...
  private val poll = Poll(
    id = PollId.PaidExparo,
    title = "How much are you willing to pay for Exparo Wallet?",
    description = "To continue to exist, Exparo Wallet needs maintenance." +
