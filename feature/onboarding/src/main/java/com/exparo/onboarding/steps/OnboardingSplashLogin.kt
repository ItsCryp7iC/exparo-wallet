...
import com.exparo.legacy.utils.springBounceSlow
    ...
    val spacerTop by transition.animateDp(
        ...
        when (it) {
            OnboardingState.SPLASH -> {
                (exparoContext.screenHeight / 2f - logoHeight.toDensityPx() / 2f).toDensityDp()
            }
        ...
        Image(
            modifier = Modifier
                ...
                .layout { measurable, constraints ->
                    ...
                    val xSplash = exparoContext.screenWidth / 2f - placeable.width / 2
            ...
            painter = painterResource(id = R.drawable.exparo_wallet_logo),
            contentScale = ContentScale.FillBounds,
            contentDescription = "Exparo Wallet logo"
        )
...
@Composable
private fun LocalAccountExplanation(modifier: Modifier = Modifier) { // 1. Add modifier parameter
    Column(modifier = modifier) { // 2. Use a Column and apply the modifier to it
        Text(
