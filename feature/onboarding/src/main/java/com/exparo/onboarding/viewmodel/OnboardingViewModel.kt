...
import com.exparo.onboarding.OnboardingDetailState
import com.exparo.onboarding.OnboardingEvent
...
class OnboardingViewModel @Inject constructor(
    ...
    private val _currency = mutableStateOf(ExparoCurrency.getDefault())
    ...
    private suspend fun initiateSettings(isSystemDarkMode: Boolean) {
        val defaultCurrency = ExparoCurrency.getDefault()
    ...
    private suspend fun setBaseCurrency(baseCurrency: ExparoCurrency) {
    ...
    private suspend fun updateBaseCurrency(baseCurrency: ExparoCurrency) {
        ioThread {
            settingsWriter.save(
