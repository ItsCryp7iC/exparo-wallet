...
import com.exparo.design.l0_system.*
import com.exparo.design.utils.*
...
fun InputField(
    ...
    inputType: ExparoInputType = ExparoInputType.SHORT_TEXT,
    imeAction: ExparoImeAction = ExparoImeAction.DONE,
    ...
    AndroidView(
        ...
        update = {
            ...
            when (inputType) {
                ExparoInputType.PASSWORD, ExparoInputType.PASSWORD_NUMBER,
                ExparoInputType.PASSWORD_VISIBLE, ExparoInputType.PASSWORD_NUMBER_VISIBLE -> {
                    it.setupInputType(
                        inputType = inputType,
                        imeAction = imeAction,
                        onImeActionListener = onImeActionListener
            ...
            Log.d("exparoInputField", "Triggering recomposition: ${focus?.triggerRecomposition}")
