package com.exparo.design.api.systems
...
abstract class ExparoWalletDesign : ExparoDesign {
    companion object {
    ...
    @Deprecated("Old design system. Use `:exparo-design` and Material3")
    override fun typography(): ExparoTypography {
        ...
        return object : ExparoTypography {
    ...
    @Deprecated("Old design system. Use `:exparo-design` and Material3")
    override fun colors(theme: Theme, isDarkModeEnabled: Boolean): ExparoColors {
        return when (theme) {
            Theme.LIGHT -> object : ExparoColors {
                ...
                override val primary1 = ExparoDark
            ...
            Theme.DARK -> object : ExparoColors {
                ...
                override val primary = Purple
                override val primary1 = ExparoLight
            ...
            Theme.AMOLED_DARK -> object : ExparoColors {
    ...
    @Deprecated("Old design system. Use `:exparo-design` and Material3")
    override fun shapes(): ExparoShapes {
        return object : ExparoShapes() {
