package com.exparo.wallet.ui.theme
...
// Light
@Deprecated("Old design system. Use `:exparo-design` and Material3")
val ExparoLight = Color(0xFFD5CCFF)
...
// Dark
@Deprecated("Old design system. Use `:exparo-design` and Material3")
val ExparoDark = Color(0xFF1C2881)
...
@Deprecated("Old design system. Use `:exparo-design` and Material3")
val GradientExparo = Gradient(Exparo, Color(0xFF74B4FF))
...
data class Gradient(
    ...
    companion object {
        @Deprecated("Old design system. Use `:exparo-design` and Material3")
        fun from(gradient: com.exparo.design.l0_system.Gradient) =
