...
import com.exparo.legacy.data.model.filterOverdueLegacy
import com.exparo.legacy.data.model.filterUpcoming
import com.exparo.legacy.data.model.filterUpcomingLegacy
...
import com.exparo.wallet.domain.deprecated.logic.currency.ExchangeRatesLogic
import com.exparo.wallet.domain.deprecated.logic.currency.sumInBaseCurrency
...
class WalletCategoryLogic @Inject constructor(
    ...
    suspend fun calculateUnspecifiedBalance(range: com.exparo.legacy.data.model.FromToTimeRange): Double {
        return calculateUnspecifiedIncome(range) - calculateUnspecifiedExpenses(range)
    }

    suspend fun calculateUnspecifiedIncome(range: com.exparo.legacy.data.model.FromToTimeRange): Double {
        return transactionRepository
    ...
    suspend fun calculateUnspecifiedExpenses(range: com.exparo.legacy.data.model.FromToTimeRange): Double {
        return transactionRepository
            .findAllUnspecifiedAndTypeAndBetween(
                type = TransactionType.EXPENSE,
                startDate = range.from(),
    ...
    suspend fun historyUnspecified(range: com.exparo.legacy.data.model.FromToTimeRange): List<TransactionHistoryItem> {
        return with(LegacyTrnDateDividers) {
            transactionRepository
    ...
    suspend fun calculateUpcomingIncomeUnspecified(range: com.exparo.legacy.data.model.FromToTimeRange): Double {
    ...
    suspend fun calculateUpcomingExpensesUnspecified(range: com.exparo.legacy.data.model.FromToTimeRange): Double {
        return upcomingUnspecifiedLegacy(range = range)
            .filter { it.type == TransactionType.EXPENSE }
            .sumInBaseCurrency(
                exchangeRatesLogic = exchangeRatesLogic,
    ...
    @Deprecated("Uses legacy Transaction")
    suspend fun upcomingUnspecifiedLegacy(range: com.exparo.legacy.data.model.FromToTimeRange): List<Transaction> {
    ...
    suspend fun calculateOverdueIncomeUnspecified(range: com.exparo.legacy.data.model.FromToTimeRange): Double {
    ...
    suspend fun calculateOverdueExpensesUnspecified(range: com.exparo.legacy.data.model.FromToTimeRange): Double {
        return overdueUnspecifiedLegacy(range = range)
            .filter { it.type == TransactionType.EXPENSE }
            .sumInBaseCurrency(
                exchangeRatesLogic = exchangeRatesLogic,
    ...
    @Deprecated("Uses legacy Transaction")
    suspend fun overdueUnspecifiedLegacy(range: com.exparo.legacy.data.model.FromToTimeRange): List<Transaction> {
        return transactionRepository.findAllDueToBetweenByCategoryUnspecified(
            startDate = range.from(),
            endDate = range.overdueTo(timeProvider)
        )
