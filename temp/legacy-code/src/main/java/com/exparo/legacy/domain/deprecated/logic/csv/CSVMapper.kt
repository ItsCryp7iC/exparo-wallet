package com.exparo.wallet.domain.deprecated.logic.csv
...
import com.exparo.wallet.domain.deprecated.logic.csv.model.JoinResult
...
class CSVMapper @Inject constructor() {
    ...
    private fun exparoMappingV1() = RowMapping(
        date = 0,
        title = 1,
        category = 2,
        account = 3,
    ...
    private fun exparoMappingV2() = RowMapping(
        date = 0,
        title = 1,
        category = 2,
        account = 3,
