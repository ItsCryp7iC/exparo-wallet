package com.exparo.legacy.domain.pure.transaction
...
import com.exparo.legacy.utils.toEpochSeconds
import com.exparo.wallet.domain.data.TransactionHistoryDateDivider
...
import com.exparo.wallet.domain.pure.transaction.LegacyTrnFunctions
...
object LegacyTrnDateDividers {
    @Deprecated("Migrate to actions")
    suspend fun List<com.exparo.base.legacy.Transaction>.withDateDividers(
        exchangeRatesLogic: ExchangeRatesLogic,
        settingsDao: SettingsDao,
        accountDao: AccountDao,
    ...
    @Pure
    suspend fun transactionsWithDateDividers(
        transactions: List<com.exparo.base.legacy.Transaction>,
        baseCurrencyCode: String,
        timeConverter: TimeConverter,
