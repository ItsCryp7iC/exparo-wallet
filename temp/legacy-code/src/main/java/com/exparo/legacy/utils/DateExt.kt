...
import com.exparo.base.time.INSTANT_MAX_SAFE
import com.exparo.base.time.INSTANT_MIN_SAFE
import com.exparo.base.time.TimeConverter
import com.exparo.frp.Total
...
fun exparoMinTime(): Instant = INSTANT_MIN_SAFE

fun exparoMaxTime(): Instant = INSTANT_MAX_SAFE
