...
import com.exparo.legacy.utils.exparoMaxTime
...
fun Iterable<com.exparo.data.model.Transaction>.filterUpcoming(): List<com.exparo.data.model.Transaction> {
...
fun Iterable<com.exparo.data.model.Transaction>.filterOverdue(): List<com.exparo.data.model.Transaction> {
    val todayStartOfDayUTC = dateNowUTC().atStartOfDay().toInstant(ZoneOffset.UTC)
