package com.exparo.wallet.domain.deprecated.logic.notification
...
import com.exparo.legacy.utils.atEndOfDay
import com.exparo.ui.R
import com.exparo.wallet.android.notification.ExparoNotificationChannel
import com.exparo.wallet.android.notification.NotificationService
    ...
    override suspend fun doWork() = withContext(Dispatchers.IO) {
        ...
        if (transactionsToday.size < MINIMUM_TRANSACTIONS_PER_DAY && showNotifications) {
            ...
            val notification = notificationService
                .defaultExparoNotification(
                    channel = ExparoNotificationChannel.TRANSACTION_REMINDER,
                    priority = NotificationCompat.PRIORITY_HIGH
                )
                .setContentTitle("Exparo Wallet")
