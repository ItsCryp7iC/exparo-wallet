...
@Singleton
class ExparoWalletCtx @Inject constructor() : ExparoContext() {
    // ------------------------------------------ State ---------------------------------------------
    @Deprecated("Legacy code. Don't use it, please.")
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    var selectedPeriod: com.exparo.legacy.data.model.TimePeriod =
        com.exparo.legacy.data.model.TimePeriod.currentMonth(
    ...
    ): com.exparo.legacy.data.model.TimePeriod {
        if (!selectedPeriodInitialized || forceReinitialize) {
            selectedPeriod = com.exparo.legacy.data.model.TimePeriod.currentMonth(
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    fun updateSelectedPeriodInMemory(period: com.exparo.legacy.data.model.TimePeriod) {
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    var mainTab by mutableStateOf(com.exparo.legacy.data.model.MainTab.HOME)
        private set

    @Deprecated("Legacy code. Don't use it, please.")
    fun selectMainTab(tab: com.exparo.legacy.data.model.MainTab) {
        mainTab = tab
    }
    ...
    @Deprecated("Legacy code. Don't use it, please.")
    fun reset() {
        mainTab = com.exparo.legacy.data.model.MainTab.HOME
        startDayOfMonth = 1
        isPremium = true
