...
import com.exparo.data.temp.migration.settleNow
...
import com.exparo.wallet.domain.deprecated.logic.currency.sumByDoublePlannedInBaseCurrency
...
class PlannedPaymentsLogic @Inject constructor(
    ...
    suspend fun plannedPaymentsAmountFor(range: com.exparo.legacy.data.model.FromToTimeRange): Double {
    ...
    suspend fun payOrGet(
        transaction: com.exparo.data.model.Transaction,
        syncTransaction: Boolean = true,
        skipTransaction: Boolean = false,
        onUpdateUI: suspend (paidTransaction: com.exparo.data.model.Transaction) -> Unit
    ) {
    ...
    suspend fun payOrGet(
        transactions: List<com.exparo.data.model.Transaction>,
        syncTransaction: Boolean = true,
        skipTransaction: Boolean = false,
        onUpdateUI: suspend (paidTransactions: List<com.exparo.data.model.Transaction>) -> Unit
    ) {
        val paidTransactions: List<com.exparo.data.model.Transaction> =
