package com.exparo.widget.balance
...
import com.exparo.legacy.utils.shortenAmount
...
import com.exparo.widgets.WidgetBase
...
class WalletBalanceWidgetReceiver : GlanceAppWidgetReceiver() {
    ...
    @Inject
    lateinit var exparoContext: com.exparo.legacy.ExparoWalletCtx
    ...
    private fun updateData(context: Context) {
        coroutineScope.launch {
            ...
            val appLocked = com.exparo.legacy.utils.ioThread {
            ...
            val period = exparoContext.selectedPeriod
