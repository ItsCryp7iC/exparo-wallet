...
class ExparoRoomDatabaseMigrationTest {

    @get:Rule
    val helper: MigrationTestHelper = MigrationTestHelper(
        InstrumentationRegistry.getInstrumentation(),
        ExparoRoomDatabase::class.java,
        listOf(ExparoRoomDatabase.DeleteSEMigration()),
    ...
    fun migrateAll() {
        ...
        // for Exparo Wallet versions below 106 are broken :/
        ...
        Room.databaseBuilder(
            ...
            ExparoRoomDatabase::class.java,
            TestDb
        ).addMigrations(*ExparoRoomDatabase.migrations()).build().apply {
