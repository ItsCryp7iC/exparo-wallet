package com.exparo.domain.usecase.wallet

import arrow.core.Option
import com.exparo.data.model.Value
...
import com.exparo.domain.usecase.account.AccountBalanceUseCase
...
class WalletBalanceUseCase @Inject constructor(
    ...
    /**
     * Calculates the all-time balance of Exparo Wallet by summing
