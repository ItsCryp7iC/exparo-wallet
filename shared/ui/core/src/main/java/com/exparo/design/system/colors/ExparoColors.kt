package com.exparo.design.system.colors
...
object ExparoColors {
    ...
    val PrimaryBlue = ColorShades(
        extraLight = Color(0xFFE3F2FD),
        light = Color(0xFFBBDEFB),
        kindaLight = Color(0xFF90CAF9),
    ...
    // Secondary Green - Secondary brand color
    val SecondaryGreen = ColorShades(
        extraLight = Color(0xFFE8F5E8),
        light = Color(0xFFC8E6C9),
        kindaLight = Color(0xFFA5D6A7),
