...
android {
    namespace = "com.exparo.wallet"
    compileSdk = libs.versions.compile.sdk.get().toInt()

    defaultConfig {
        applicationId = "com.exparo.wallet"
    ...
    signingConfigs {
        ...
        //     storePassword = "EXPARO7834!DEbug"
        //     keyAlias = "debug"
        //     keyPassword = "EXPARO7834!DEbug"
        // }

        // <-- UNCOMMENT THIS BLOCK for release builds -->
        create("release") {
    ...
    buildTypes {
        release {
            ...
            // This line is now correct because the release signingConfig is uncommented
        ...
        debug {
            // <-- UNCOMMENT THESE LINES to get useful debug features back -->
            ...
            // <-- KEEP THIS LINE COMMENTED OUT. This is the main fix. -->
        ...
        create("demo") {
            ...
            // <-- COMMENT THIS LINE OUT so the demo build also uses the automatic debug key -->
            // signingConfig = signingConfigs.getByName("debug")

            applicationIdSuffix = ".debug"
            resValue("string", "app_name", "Exparo Demo")
        }
    }
