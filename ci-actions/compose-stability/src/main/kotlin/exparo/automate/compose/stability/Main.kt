package exparo.automate.compose.stability
...
import exparo.automate.compose.stability.model.ComposableArgument
import exparo.automate.compose.stability.model.FullyQualifiedName
import exparo.automate.compose.stability.model.UnstableComposable
import java.io.File
import kotlin.system.exitProcess

const val OutputReportFileName = "exparo-compose-stability-report.txt"
const val ComposeReportFolderName = "compose_compiler"
const val BaselineArg = "generateBaseline"
const val BaselineFileName = "exparo-compose-stability-baseline.txt"
...
fun main(args: Array<String>) {
    ...
    val exparoReportTxt = buildExparoReport(unstableComposables)
    createReportFile(exparoReportTxt)
    println(exparoReportTxt)
